...
%post	-n Qt3Support -p /usr/sbin/ldconfig
%postun	-n Qt3Support -p /usr/sbin/ldconfig

%post	-n QtCLucene -p /usr/sbin/ldconfig
%postun	-n QtCLucene -p /usr/sbin/ldconfig

%post	-n QtCore -p /usr/sbin/ldconfig
%postun	-n QtCore -p /usr/sbin/ldconfig

%post	-n QtDBus -p /usr/sbin/ldconfig
%postun	-n QtDBus -p /usr/sbin/ldconfig

%post	-n QtDeclarative -p /usr/sbin/ldconfig
%postun	-n QtDeclarative -p /usr/sbin/ldconfig

%post	-n QtDesigner -p /usr/sbin/ldconfig
%postun	-n QtDesigner -p /usr/sbin/ldconfig

%post	-n QtGui -p /usr/sbin/ldconfig
%postun	-n QtGui -p /usr/sbin/ldconfig

%post	-n QtHelp -p /usr/sbin/ldconfig
%postun	-n QtHelp -p /usr/sbin/ldconfig

%post	-n QtMultimedia -p /usr/sbin/ldconfig
%postun	-n QtMultimedia -p /usr/sbin/ldconfig

%post	-n QtNetwork -p /usr/sbin/ldconfig
%postun	-n QtNetwork -p /usr/sbin/ldconfig

%post	-n QtOpenGL -p /usr/sbin/ldconfig
%postun	-n QtOpenGL -p /usr/sbin/ldconfig

%post   -n QtScript -p /usr/sbin/ldconfig
%postun -n QtScript -p /usr/sbin/ldconfig

%post   -n QtScriptTools -p /usr/sbin/ldconfig
%postun -n QtScriptTools -p /usr/sbin/ldconfig

%post	-n QtSql -p /usr/sbin/ldconfig
%postun	-n QtSql -p /usr/sbin/ldconfig

%post	-n QtSvg -p /usr/sbin/ldconfig
%postun	-n QtSvg -p /usr/sbin/ldconfig

%post	-n QtTest -p /usr/sbin/ldconfig
%postun	-n QtTest -p /usr/sbin/ldconfig

%post	-n QtUiTools -p /usr/sbin/ldconfig
%postun	-n QtUiTools -p /usr/sbin/ldconfig

%post	-n QtWebKit -p /usr/sbin/ldconfig
%postun	-n QtWebKit -p /usr/sbin/ldconfig

%post	-n QtXml -p /usr/sbin/ldconfig
%postun	-n QtXml -p /usr/sbin/ldconfig

%post   -n QtXmlPatterns -p /usr/sbin/ldconfig
%postun -n QtXmlPatterns -p /usr/sbin/ldconfig
